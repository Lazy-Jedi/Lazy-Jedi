...
namespace LazyJedi.Editors.Internal
{
    public static class LazyEditorStyles
    {
        ...
        {
            get => EditorGUIUtility.isProSkin ? CommonColours.UnityFontColorLite : CommonColours.UnityFontColorDark;
        }
        ...
        {
            return NewCustomCenteredLabel(CommonColours.UnityFontColorLite, CommonColours.UnityFontColorDark, fontSize);
        }
